...
func bitcoinRegistrationFixture(t *testing.T, e *env, c bitcoinPaymentContext, p bitcoinPaymentPlan, session *btcec.PrivateKey, outputs []*wire.TxOut) lightRenewalRegisterRequest {
	t.Helper()
	indexes := []int{1}
	if len(p.Outputs) == 2 {
