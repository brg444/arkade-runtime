...
The v2 service starts from one fresh database schema and accepts one enrollment
template. It does not load the Mutinynet migration ladder or older vault
templates.
